...
async function loadContenedorFiltro() {
    await loadTemplate('Contenedor_filtro', 'template-ajustes');
}

// Ejecutar cuando el DOM esté cargado
document.addEventListener("DOMContentLoaded", loadContenedorFiltro);
